          ...
          return (
            ...
            >
              <Link
                ...
                className="group relative block rounded-2xl bg-white ring-1 ring-neutral-200 p-5 shadow-soft hover:shadow-pop hover:ring-primary-300 transition-all overflow-hidden"
              >
                <div
                  aria-hidden
                  className={cn(
