...
export function Hero() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 -z-10 opacity-[0.2] bg-[linear-gradient(to_right,var(--color-border)_1px,transparent_1px),linear-gradient(to_bottom,var(--color-border)_1px,transparent_1px)] bg-[size:48px_48px] [mask-image:radial-gradient(ellipse_at_top,black,transparent_70%)]"
      />

      <div className="mx-auto max-w-6xl px-4 sm:px-6 pt-14 pb-20 sm:pt-20 sm:pb-28 grid lg:grid-cols-[1.1fr_1fr] gap-10 lg:gap-14 items-center">
        <motion.div style={{ y: textY }} className="text-center lg:text-left">
          ...
          <motion.h1
            ...
            className="mt-6 font-display text-4xl sm:text-6xl font-black leading-[1.02] tracking-tight text-neutral-900"
          >
            Reportá los baches
            <br />
          ...
          <motion.p
            ...
            className="mt-5 text-lg text-neutral-700 max-w-xl lg:max-w-none mx-auto lg:mx-0"
          >
            Una foto, tu GPS y una descripción corta. Tu reporte queda público
            en un mapa agregado. El municipio responde. Los vecinos también confirman.
          </motion.p>
